...
INPUT_WSI = "../data/spatial_atac/modified_images/BCSA4_A2_sATAC_C1_adjacent-Spot000001_v3_newrot_newcrop_realcolors_nofakescaling.jpg"  # Visium
...
# Path for model A
output_folder_model_A = os.path.join(output_folder_staingan, "model_A")
...
with open(normalisation_fails_file, "w") as file:
    ...
    try:
        ...
        output_path = os.path.join(output_folder_model_A, f"{os.path.splitext(filename)[0]}_{normalisation_method}_StainGAN_modelA.jpg") # or .png (but it's way bigger)
